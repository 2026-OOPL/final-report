...
#### 地圖生成系統
地圖生成系統是由一個父類 ``GenChamber`` 與許多繼承自它的子類實作而成，每個子類都專注於生成不同類的房間，且我們將 ``MapBlueprint`` 依賴注入到每個生成氣讓他們可以接續性的完成地圖生成任務。 
```mermaid
classDiagram
...
### 心得
#### 邱冠勛
這次的 OOPL 專案可說是我人生中第一次長時間且有目標的與其他成員共同開發一個程式，當我發現自己不再是孤身一人時比起開心，更多的是擔憂，我很擔心我能否與我的組員好好模合併默契配合。
時間來到專案開發之初，我與組員保持至少每週除了課堂上至少一次的課後會議來制定程式架構與分工，我人為這是最困難的部分，因為一開始對於彼此的開發習慣不熟悉，導致許多無效溝通與架構上想法的不同。
但隨著時間推進，專案也漸漸走上正軌，由於大致的架構已經決定好，所以我們終於有一個基礎可以開發，並基於此制定更多實作上的需求，我們採用先講好會給對方流什麼接口調用，再回家把功能實作的方式，
...
最後到了期末，遊戲開發接近尾聲，只剩下一些功能上的小修小補，我認為整體而言還是很有成就感的。雖然我們的作品與原作可能還是差的有點多，但我認為開發過程中所習的的都是珍貴的，
